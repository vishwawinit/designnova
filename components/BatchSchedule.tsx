      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <div className="flex flex-col md:flex-row">
            ...
            {/* Left purple column — "NEW BATCHES STARTING EVERY MONDAY" */}
            <div
              className="flex-shrink-0 flex items-center justify-center px-7 py-10"
              style={{
                background: "linear-gradient(160deg, #C82EFF 0%, #D447FF 100%)",
                minWidth: "200px",
                maxWidth: "200px",
              }}
            >
              ...
              >
                New<br />Batches<br />Starting<br />Every<br />Monday
              </h2>
            </div>
            ...
            <div className="flex-1 flex flex-col">
              ...
              {/* Cards + badge row */}
              <div className="flex flex-col md:flex-row gap-0 pb-4 px-3 items-stretch">

                {/* Weekday card */}
                <div className="flex-1 bg-white rounded-2xl m-2 p-5 flex flex-col justify-between">
                  <div>
