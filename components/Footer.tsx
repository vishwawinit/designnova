...
export default function Footer() {
  return (
    <footer className="relative pt-20 pb-8 overflow-hidden bg-[#04000B] border-t border-white/5">
      {/* Top glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-px bg-gradient-to-r from-transparent via-[#D447FF]/50 to-transparent" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 pb-14 border-b border-white/5">
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2">
            ...
            <div className="flex items-center gap-2 text-white/40 text-xs mb-2">
              <Mail size={13} className="text-[#D447FF]" />
              <span>hello@designnova.in</span>
            </div>
            <div className="flex items-center gap-2 text-white/40 text-xs">
              <Phone size={13} className="text-[#D447FF]" />
          ...
          <div className="flex items-center gap-3">
            {socials.map((s, i) => (
              <a
                key={i}
                href={s.href}
                className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-[#D447FF] hover:border-[#D447FF]/40 transition-all"
              >
                {s.icon}
              </a>
            ))}
