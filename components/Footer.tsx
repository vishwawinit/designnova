...
const links = {
  Design:  ["UI/UX Course", "Curriculum", "Projects", "Certification", "Internship", "Free Demo"],
  Company: ["About Us", "Blog", "Careers", "Contact Us", "Privacy Policy", "Refund Policy"],
  Support: ["Help Center", "Community", "WhatsApp Support", "Batch Schedule", "Webinars", "Events"],
};
...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="relative bg-[#0D0015] overflow-hidden">
      ...
      <div className="relative border-b border-white/6">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <h3 className="text-white font-bold text-xl mb-1">Get free design tips weekly</h3>
              <p className="text-white/40 text-sm">Industry news, career advice & early batch alerts — every week.</p>
            </div>
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex items-center gap-2">
                <input
                  ...
                  required
                  className="w-60 bg-white/8 border border-white/12 text-white text-sm px-4 py-2.5 rounded-full placeholder-white/30 focus:outline-none focus:border-[#D447FF]/60 transition-all"
                />
                <button type="submit" className="btn-purple text-sm font-bold px-5 py-2.5 rounded-full">
                  Subscribe
                </button>
              </form>
            )}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 pb-12 border-b border-white/5">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-white/35 text-sm leading-relaxed max-w-xs mb-6">
              India's leading UI/UX design bootcamp. Learn industry-ready skills with AI tools
              and land your dream design job in 60 days. Free internship included.
            </p>

            {/* Real contact from Frame 105 SVG */}
            <div className="flex flex-col gap-2.5 mb-6">
              <a href="mailto:designnova@gmail.com" className="flex items-center gap-2.5 text-white/40 hover:text-white/70 text-xs transition-colors">
                <Mail size={12} style={{ color: "#D447FF", flexShrink: 0 }} />
                designnova@gmail.com
              </a>
              <a href="tel:+917467367477" className="flex items-center gap-2.5 text-white/40 hover:text-white/70 text-xs transition-colors">
                <Phone size={12} style={{ color: "#D447FF", flexShrink: 0 }} />
                +91 7467367477
              </a>
              <div className="flex items-center gap-2.5 text-white/40 text-xs">
                <MapPin size={12} style={{ color: "#D447FF", flexShrink: 0 }} />
